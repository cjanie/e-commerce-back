...
import com.oc_p8.ecommerce.ordercycle.businesslogic.usecases.commands.SaveOrderReadyUseCase;
...
public class OrderReadyController {
    ...
    public ResponseEntity<?> passOrderToReady(@RequestBody OrderActionDTO actionDTO) {
        try {
            ...
            Long id = new SaveOrderReadyUseCase(new OrderReadyCommandGatewayImpl(this.commandRepository))
                    .handle(order);
